...
pub fn Nav() -> impl IntoView {
    view! {
        <nav class="text-lg fixed bottom-0 w-full">
            <ul class="flex gap-4 justify-center items-stretch h-12 bg-green-200 dark:bg-gray-900 dark:text-gray-200">
                <a class="px-2 content-center" href="/"><li>Summary</li></a>
